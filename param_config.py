# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 17:00:23 2016
...
__author__
    Charles-Abner Dadi <charlesabner.dadi@gmail.com >
"""
...
class ParamConfig:
    def __init__(self,
        ...
        self.original_cliente_tabla_data_path = "%s/cliente_tabla.csv" % self.data_folder
        self.original_producto_tabla_path = "%s/producto_tabla.csv" % self.data_folder
        self.original_town_state_data_path = "%s/town_state.csv" % self.data_folder
        self.original_sample_submission_data_path = "%s/sample_submission.csv" % self.data_folder        
